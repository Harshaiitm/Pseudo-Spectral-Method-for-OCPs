...
x0(10*M+1:11*M) = (60000 + Re)/2;                      % Rx_2
x0(11*M+1:12*M) = 0;               % Ry_2 
x0(12*M+1:13*M) = (60000 + Re)/2;               % Rz_2 
x0(13*M+1:14*M) = sqrt(mu/((65000+Re)/2));                      % Vx_2 
x0(14*M+1:15*M) = 0;                      % Vy_2
x0(15*M+1:16*M) = sqrt(mu/((65000+Re)/2));                      % Vz_2
x0(16*M+1:17*M) = m0_2;                % mass_2
x0(17*M+1:18*M) = Thrust_max_2;        % Thrust_x2
x0(18*M+1:19*M) = 0;        % Thrust_y2
