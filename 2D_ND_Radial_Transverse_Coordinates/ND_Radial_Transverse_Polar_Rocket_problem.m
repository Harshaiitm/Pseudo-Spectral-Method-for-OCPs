...
200000);
    ...
    if strcmp(PS_method,'CGL')
       [x,fval,ef,output] = fmincon(@(x) ND_2D_Radial_Transverse_Polar_Rocket_objective_func(x,M,m0,n_mass),x0,A,b,Aeq,beq,lb,ub,@(x) ND_2D_Radial_Transverse_Polar_Rocket_Nonlinear_func_CGL(x,M,D,problem),options);
    end
