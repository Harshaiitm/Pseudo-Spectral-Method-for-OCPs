...
x0(17*M+1:18*M) = Vx_I(M+1:2*M);                        % Vx_2 
x0(18*M+1:19*M) = Vy_I(M+1:2*M);                        % Vy_2
x0(19*M+1:20*M) = Vz_I(M+1:2*M);                        % Vz_2
x0(20*M+1:21*M) = linspace(m0_2,mass2_f,M);                     % mass_2
x0(21*M+1:22*M) = linspace(Thrust_max_2,10,M);              % Thrust_x2
x0(22*M+1:23*M) = 0;              % Thrust_y2
x0(23*M+1:24*M) = 0;              % Thrust_z2
