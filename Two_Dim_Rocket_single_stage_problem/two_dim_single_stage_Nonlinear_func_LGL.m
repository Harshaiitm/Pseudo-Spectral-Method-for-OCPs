...
ceq(5*N+5,1) = 0-h_x(1);
ceq(5*N+6,1) = 0-h_y(1);
ceq(5*N+7,1) = 0-(h_x(1)^2+h_y(1)^2)^0.5;
ceq(5*N+8,1) = hf-(h_x(end)^2+h_y(end)^2)^0.5;
ceq(5*N+9,1) = 0-V_x(1);
ceq(5*N+10,1) = 0-V_y(1);
ceq(5*N+11,1) = 0-(V_x(1)^2+V_y(1)^2)^0.5;
ceq(5*N+12,1) = (mu/R(end))^0.5 -(V_x(end)^2+V_y(end)^2)^0.5;
ceq(5*N+13,1) = 0-(V_x(end)*h_x(end)+V_y(end)*h_y(end));
