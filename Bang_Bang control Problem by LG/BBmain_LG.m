...
Objective = BB_Objective_func_LG(x,N);
[c, ceq, dc, dceq] = BB_Nonlinearcon_func_LG(x,N,D,t0,tf);
...
20000);
[x,fval,ef,output] = fmincon(@BB_Objective_func_LG,x0,A,b,Aeq,beq,lb,ub,@(x)BB_Nonlinearcon_func_LG(x,N,D,t0,tf),options);
