function [c,ceq,dc,dceq] = multi_stage_Nonlinear_func_LGL_OPTI(x,N,D,problem)   %inequality constarints                      
dc = [];
dceq = [];
...
ceq(6*N+12) = mass_1(end)-3200;
ceq(6*N+13) = mass_2(1)-2000;
ceq(6*N+14) = mass_2(end)-800;
